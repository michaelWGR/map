...
class Keymsg(models.Model):
    ...
    type = models.IntegerField(max_length=10, default=0, verbose_name='key的类型，0：高德地图')
    is_deleted = models.IntegerField(max_length=10, default=0, verbose_name='是否已删除，0：未删除，1：已删除')
